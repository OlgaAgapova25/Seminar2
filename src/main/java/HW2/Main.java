    ...
    /*
     ...
     1. Настроить новый проект:
         ...
         c). Написать следующие тесты:
             - проверка того, что экземпляр объекта HW2.Car также является экземпляром транспортного средства; (instanceof)
             - проверка того, объект HW2.Car создается с 4-мя колесами
             - проверка того, объект HW2.Motorcycle создается с 2-мя колесами
             - проверка того, объект HW2.Car развивает скорость 60 в режиме тестового вождения (testDrive())
             - проверка того, объект HW2.Motorcycle развивает скорость 75 в режиме тестового вождения (testDrive())
